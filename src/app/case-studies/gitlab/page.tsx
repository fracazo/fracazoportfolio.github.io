      ...
      <section className="section case-study-content">
        <div className="case-study-main">
          ...
          <div className="case-study-section">
            <p>I am the sole product designer on GitLab&rsquo;s Knowledge team, owning UX for Wiki, GLQL (GitLab Query Language), Pages, and text editors on a platform used by millions of developers. I led GLQL, the first query language built natively into GitLab, for embedding live, filtered views of issues into wikis and docs, from research to a GA launch where adoption grew 33%. I led the Wiki redesign, from the panel layout to contextual comments, positioning it as a competitive alternative to Confluence. All of it shipped to production, including direct code contributions via merge requests.</p>
