      ...
      <section className="section case-study-content">
        <div className="case-study-main">
          ...
          <div className="case-study-section">
            <p>Working at GitLab has been one of the most genuinely exciting and challenging experiences of my career. Being part of a product that is used by millions of developers around the world, and contributing to it in a way that is fully transparent and open.</p>
