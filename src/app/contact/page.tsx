...
const socialLinkClass =
  "flex max-w-[280px] items-center gap-3 rounded-[10px] border border-border bg-card px-4 py-3 text-meta font-medium text-text no-underline transition-colors duration-200 hover:bg-panel-2 hover:no-underline group";
