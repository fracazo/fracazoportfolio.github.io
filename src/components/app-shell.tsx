                ...
                {navLinks.map(({ href, label, icon: Icon }) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center gap-2 rounded-lg border px-2.5 py-2 text-meta no-underline hover:border-border hover:bg-panel-2 hover:text-text hover:no-underline ${
                        active
